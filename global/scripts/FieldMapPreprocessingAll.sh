...
function tmeanInputs()
{
    ...
    # Check if input is a list of files separated by '@'
    # If so, merge them into a single 4D file and take the mean
    # If not, just take the mean of the single file
...
case $DistortionCorrection in
    ...
    $SIEMENS_METHOD_OPT)
        ...
        # -- Siemens Gradient Echo Field Maps --
        # --------------------------------------
        echo "[DEBUG] tmeanInputs input='$MagnitudeInputName'" >&2
